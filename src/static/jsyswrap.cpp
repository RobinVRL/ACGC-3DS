...
#ifdef TARGET_PC
        OSReport("[PC] JW_Init2: mounting forest_1st.arc...\n");
#endif
...
#ifdef TARGET_PC
        OSReport("[PC] JW_Init3: mounting forest_2nd.arc...\n");
#endif
