...
#include <string.h>
#include <malloc.h>
/* Metrowerks __alloca is a compiler built-in; GCC provides the same primitive. */
...
#endif
#if !defined(__INTELLISENSE__) && !defined(TARGET_PC)
...
#if !defined(__INTELLISENSE__) && defined(MUST_MATCH) && !defined(TARGET_PC)
